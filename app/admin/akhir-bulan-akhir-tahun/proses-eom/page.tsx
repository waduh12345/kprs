...
const initialLog: LogEntry[] = [
  ...
  },
  {
    ...
    activity:
      "Memulai proses jurnal penutup (menutup Akun Pendapatan/Beban)...",
    status: "INFO",
  },
  {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Card className="border-t-4 border-indigo-500">
        <CardHeader>
          ...
          <p className="text-sm text-gray-500">
            Pilih periode yang akan ditutup. Proses ini akan menghasilkan jurnal
            penutup laba/rugi dan mengunci periode.
          </p>
        </CardHeader>
      ...
      <Card>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center p-2 border rounded-md">
              <span className="font-medium">
                1. Proses Bunga Simpanan Selesai
              </span>
              {validation.prasyarat_bunga === "OK" ? (
            ...
            <div className="flex justify-between items-center p-2 border rounded-md">
              <span className="font-medium">
                2. Proses Harian Simjaka Selesai (Hingga Akhir Bulan)
              </span>
              {validation.prasyarat_simjaka === "OK" ? (
                <Badge variant="success" className="flex items-center gap-1">
                  <CheckCircle className="h-4 w-4" /> OK
            ...
            <div className="flex justify-between items-center p-2 border rounded-md">
              <span className="font-medium">
                3. Tidak Ada Jurnal/Transaksi Draft Belum Posting
              </span>
              {validation.jurnal_belum_posted === "OK" ? (
                <Badge variant="success" className="flex items-center gap-1">
                  <CheckCircle className="h-4 w-4" /> OK
                ...
                <Badge
                  ...
                  className="flex items-center gap-1"
                >
                  <AlertTriangle className="h-4 w-4" /> Ada Draft
                </Badge>
              )}
            </div>
          </div>
        ...
        {!canProceed && (
          <CardFooter className="bg-red-50 text-red-700 font-semibold flex items-center gap-2">
            <AlertTriangle className="h-5 w-5" /> EOM TIDAK DAPAT DIJALANKAN.
            Selesaikan semua prasyarat di atas.
          </CardFooter>
        )}
      </Card>
      ...
      <p className="text-xs text-gray-500 mt-4">
        *Setelah EOM, saldo laba rugi bulanan akan dipindahkan ke akun SHU tahun
